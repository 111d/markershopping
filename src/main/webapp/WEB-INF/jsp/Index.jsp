...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            <span class="fl">欢迎&nbsp;${sessionScope.user.userName}&nbsp;|&nbsp; <a>退出</a><a href="#">我的订单</a>&nbsp;|</span>
            <span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
<%--        	<div class="un_login">还未登录！<a href="/index/to?name=Login" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>--%>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            	<li>
            ...
            <div class="price_a"><a href="/index/to?name=BuyCar">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
        </div>
    </div>
</div>
...
<div class="i_bg bg_color">
    ...
    <div class="content">
        	...
        	<div class="food_ban">
            	<div id="imgPlay2">
                    <ul class="imgs" id="actor2">
                        <li><a href="#"><img src="../../static/images/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/food_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="../../static/images/food_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="../../static/images/food_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 食品饮料 End-->
    ...
    <div class="content">
        	...
        	<div class="make_ban">
            	<div id="imgPlay3">
                    <ul class="imgs" id="actor3">
                        <li><a href="#"><img src="../../static/images/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/make_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="../../static/images/make_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="../../static/images/make_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 个人美妆 End-->
    ...
    <div class="content">
        	...
        	<div class="baby_ban">
            	<div id="imgPlay4">
                    <ul class="imgs" id="actor4">
                        <li><a href="#"><img src="../../static/images/baby_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/baby_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/baby_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="../../static/images/baby_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="../../static/images/baby_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 母婴玩具 End-->
    ...
    <div class="content">
        	...
        	<div class="home_ban">
            	<div id="imgPlay5">
                    <ul class="imgs" id="actor5">
                        <li><a href="#"><img src="../../static/images/home_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/home_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/home_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="../../static/images/home_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="../../static/images/home_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 家居生活 End-->
    ...
    <div class="content">
        	...
        	<div class="tel_ban">
            	<div id="imgPlay6">
                    <ul class="imgs" id="actor6">
                        <li><a href="#"><img src="../../static/images/tel_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/tel_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="../../static/images/tel_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="../../static/images/tel_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="../../static/images/tel_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 数码家电 End-->

...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <form action="${pageContext.request.contextPath}/index/to">
        <span class="fr">
...
<div class="menu_bg">
	<div class="menu">
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">                                                                                                                                               
        	<li><a href="/index/to?name=Index">首页</a></li>
            ...
            <div class="list_c">
                <ul class="cate_list">
                    <c:forEach items="${requestScope.productList}" var="product">
                        <li>
                            <div class="img"><a href="#"><img src="../../static/${product.pimages}" width="210" height="185" /></a></div>
                            <div class="price">
                                <font>￥<span>${product.price}</span></font> &nbsp; 26R
                            </div>
                            <div class="name"><a href="#">${product.itemName}&nbsp;&nbsp;${product.gmodel} </a></div>
                            <div class="carbg">
